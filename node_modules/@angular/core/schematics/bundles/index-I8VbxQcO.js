...
function compileDeclareClassMetadata(metadata) {
    ...
    definitionMap.set('version', checker.literal('20.0.0-next.3'));
 ...
 */
new checker.Version('20.0.0-next.3');
...
function coreVersionSupportsFeature(coreVersion, minVersion) {
    // A version of `20.0.0-next.3` usually means that core is at head so it supports
